...
import Telemetria.TelemetriaEstados;
import champ2011client.Action;
import champ2011client.Controller;
import champ2011client.SensorModel;

public class TestSteer extends Controller {
	...
	private TelemetriaEstados chart = new TelemetriaEstados("qtable_steer.csv");
	...
	public void shutdown() {
		chart.guardarHistograma("HistogramaEstados.png");
	...
	private float getSteer(SensorModel sensors) {
		...
		chart.registrarEstado(estado);

		int accion = ql.elegirAccionTest(estado);
